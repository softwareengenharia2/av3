...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <h1>Goiaba Serrana</h1>
        <hr>

        <%--Gráfico--%>
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-area-chart"></i> Acessos da Página do Cliente</div>
            <div class="card-body">
                <canvas id="myAreaChart" width="100%" height="30"></canvas>
            </div>
            <div class="card-footer small text-muted">Atualizado hoje às 18:00 PM</div>
        </div>
    </div>
    ...
    <script src="<c:url value="/assets/vendor/datatables/dataTables.bootstrap4.css"/>" ></script>
